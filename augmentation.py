...
# Example usage
original_images_dir_train = 'train'
original_images_dir_val = 'val'
augmented_images_dir_train = 'augmented_image_train/'
augmented_images_dir_val = 'augmented_image_val/'
num_augmented_images = 12

augment_images(original_images_dir_train,augmented_images_dir_train, num_augmented_images)
augment_images(original_images_dir_val, augmented_images_dir_val, num_augmented_images)